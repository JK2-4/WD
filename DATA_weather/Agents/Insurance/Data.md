...
|--|-------|--------|---------|
|1|Median Mortgage Loan repayment (2021) **only cross-sectional data** - sub-unit group level (1.74k+ units) |mortgage, rent, demographic characteristics|[CSD](https://idds.census2021.gov.hk/app/idds.html#) ; [data](https://github.com/JK2-4/WD/blob/1d-PDE/DATA_weather/Agents/Insurance/LSUG_data.csv)|
