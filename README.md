...
**Data to cite** - [Real Estate](https://data.gov.hk/en-data/dataset/hk-rvd-tsinfo_rvd-property-market-statistics) - [metadata_dict](https://www.rvd.gov.hk/datagovhk/Data_Dic.pdf) | [bi-hourly weather 14 years](https://cowin.hku.hk/english/blog.html) | [30m spatial variables](https://figshare.com/articles/dataset/Hong_Kong_climate_vegetation_and_topography_rasters/6791276) + climate models
